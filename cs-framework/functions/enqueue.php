...
if( ! function_exists( 'cs_admin_enqueue_scripts' ) ) {
  function cs_admin_enqueue_scripts() {
    ...
    wp_enqueue_script( 'cs-vendor-ace-mode-css', CS_URI .'/assets/js/vendor/mode-css.js', array( 'cs-vendor-ace' ), '1.0.0', true );
    wp_enqueue_script( 'cs-vendor-ace-mode-javascript', CS_URI .'/assets/js/vendor/mode-javascript.js', array( 'cs-vendor-ace' ), '1.0.0', true );
